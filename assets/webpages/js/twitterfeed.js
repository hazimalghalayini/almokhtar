...
$(document).ready(function () {
    ...
    var headerHTML = '';
    var loadingHTML = '';
    loadingHTML += '<div id="loading-container"><img src="http://localhost/almokhtar/assets/webpages/images/general/status-red.gif" width="32" height="32" alt="tweet loader" /></div>';

    $('#twitter-feed').html(headerHTML + loadingHTML);

    $.getJSON('http://localhost/almokhtar/assets/webpages/php/get-tweets.php',
            function (feeds) {
                //alert(feeds);
                var feedHTML = '';
