...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
    ...
    <head>
        <meta charset="utf-8" />
        <title><?=$this->config->item('website_name').'-'.'إضافة مقطع فيديو'?></title>
    ...
    <body class="fixed-top">
                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li><a href="#">إضافة مقطع فيديو</a><span class="divider-last">&nbsp;</span></li>
                            </ul>
                        ...
                        <div class="span12">
                            ...
                            <div class="widget">
                                <div class="widget-title">
                                    <h4><i class="icon-reorder"></i>إضافة مقطع فيديو</h4>
                                    <span class="tools">
                                ...
                                <div class="widget-body form">
                                    ...
                                    <form method="POST" id="add_form" onsubmit="return false;" class="form-horizontal">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" id="video_title" class="span11" />
                                            </div>
                                        </div>
                                        <div class="control-group">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <textarea class="span11" id="video_description" rows="6"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-actions">
                                            <img id="loading-image" class="hide" src="<?=  base_url()?>assets/admin/img/ajax-loader_dark.gif" />
                                            <button type="button" class="btn btn-success" onclick="add_video()">حـفظ</button>
        ...
        <script>
            ...
            function add_video() {
                $('#loading-image').show();
                var a = $('#video_description').val();
                $.ajax({
                    type: "POST",
                    url: '<?php echo base_url() . "admin/media/do_add_video/"; ?>',
                    data: {
