                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li>
                                    <a href="#">قسم الصفحات الثابتة</a> <span class="divider">&nbsp;</span>
                                </li>
                                <li><a href="#">إضافة محتوى من نحن</a><span class="divider-last">&nbsp;</span></li>
                            </ul>
                        ...
                        <div class="span12">
                            ...
                            <div class="widget">
                                <div class="widget-title">
                                    <h4><i class="icon-reorder"></i>إضافة محتوى من نحن</h4>
                                    <span class="tools">
                                ...
                                <div class="widget-body form">
                                    ...
                                    <form method="POST" id="add_form" onsubmit="return false;" class="form-horizontal">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input readonly="" type="text" id="page_name" value="من نحـن" class="span5" />
                                            </div>
                                        </div>
                                        <div class="control-group">
