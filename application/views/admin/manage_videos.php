...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
    ...
    <head>
        <meta charset="utf-8" />
        <title><?=$this->config->item('website_name').'-'.'إدارة مقاطع الفيديو'?></title>
    ...
    <body class="fixed-top">
                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li><a href="#">إدارة مقاطع الفيديو </a><span class="divider-last">&nbsp;</span></li>
                            </ul>
                        ...
                        <div class="span12">
                            ...
                            <div class="widget">
                                <div class="widget-title">
                                    <h4><i class="icon-reorder"></i>جدول يحتوي على جميع مقاطع فيديو</h4>
                                    <span class="tools">
                                    ...
                                    <table class="table table-striped table-bordered" id="videos">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="hidden-phone">عنوان الموضوع</th>
                                                <th class="hidden-phone">تفاصيل الموضوع</th>
                                    ...
                                    <div id="myModal2" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel2" aria-hidden="true">
                                        ...
                                        <div class="modal-body">
                                            <div class="control-group">
                                                <label class="control-label">تأهل تريد بالتأكيد حذف هذا الفيديو؟</label>
                                            </div>
                                        </div>
                                        <div class="modal-footer">
                                            ...
                                            <button class="btn btn-primary" onclick="delete_video()">موافق</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <script>
            ...
            var oTable = $('#videos').dataTable({
                "sDom": "<'row-fluid'<'span6'l><'span6'f>r>t<'row-fluid'<'span6'i><'span6'p>>",
                "sPaginationType": "bootstrap",
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": '<?php echo base_url(); ?>admin/media/get_all_videos/',
                "iDisplayStart ": 10,
                "oLanguage": {
            ...
            function delete_video() {
                ...
                $.ajax({
                    type: "POST",
                    url: '<?php echo base_url() . "admin/media/delete_video/"; ?>',
                    data: {
                        video_id: curr_id
                    },
                    dataType: "json",
