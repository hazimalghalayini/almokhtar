...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
    ...
    <head>
        <meta charset="utf-8" />
        <title><?=$this->config->item('website_name').'-'.'تعديل بيانات مقطع الفيديو'?></title>
    ...
    <body class="fixed-top">
                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li><a href="#">تعديل  مقطع الفيديو</a><span class="divider-last">&nbsp;</span></li>
                            </ul>
                        ...
                        <div class="span12">
                            ...
                            <div class="widget">
                                <div class="widget-title">
                                    <h4><i class="icon-reorder"></i>تعديل بيانات مقطع الفيديو</h4>
                                    <span class="tools">
                                ...
                                <div class="widget-body form">
                                    ...
                                    <form method="POST" id="add_form" onsubmit="return false;" class="form-horizontal">
                                        <div class="control-group">
                                                    <label class="control-label">عنوان الموضوع</label>
                                                    <div class="controls">
                                                        <input type="text" id="video_title" class="span11" value="<?=$data['video_title']?>" />
                                                    </div>
                                                </div>
                                        <div class="control-group">
                                            <label class="control-label">رابط ملف الفيديو</label>
                                            <div class="controls">
                                                <input type="url" id="video_src" name="video_src" class="span11" value="<?=$data['video_src']?>" />
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label">نص الموضوع</label>
                                            <div class="controls">
                                                <textarea class="span11 ckeditor" id="video_description" rows="6"><?=$data['video_description']?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-actions">
                                            <img id="loading-image" class="hide" src="<?=  base_url()?>assets/admin/img/ajax-loader_dark.gif" />
                                            <button type="button" class="btn btn-success" onclick="update_video()">حـفظ</button>
        ...
        <script>
            ...
            function update_video() {
                ...
                $.ajax({
                    type: "POST",
                    url: '<?php echo base_url() . "admin/media/do_update_video/"; ?>',
                    data: {
                        video_id: '<?=$data['video_id']?>',
                        video_src: $('#video_src').val(),
                        video_title: $('#video_title').val(),
                        video_description: CKEDITOR.instances.video_description.getData()
                    },
                    dataType: "json",
