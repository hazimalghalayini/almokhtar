...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
    ...
    <head>
        <meta charset="utf-8" />
        <title><?=$this->config->item('website_name').'-'.'إضافة أخبار مرئية'?></title>
    ...
    <body class="fixed-top">
                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li><a href="#">إضافة أخبار مرئية</a><span class="divider-last">&nbsp;</span></li>
                            </ul>
                        ...
                        <div class="span12">
                            ...
                            <div class="widget">
                                <div class="widget-title">
                                    <h4><i class="icon-reorder"></i>إضافة أخبار مرئية</h4>
                                    <span class="tools">
                                ...
                                <div class="widget-body form">
                                    ...
                                    <form method="POST" id="add_form" onsubmit="return false;" class="form-horizontal">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <select id="country_id" class="span11 chosen" data-placeholder="يجب إختيار الدولة التي يخصها الخبر" tabindex="1">
                                                    <option value=""></option>
                                                    <?php
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" id="news_title" class="span11" />
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label">رابط ملف الفيديو</label>
                                            <div class="controls">
                                                <input type="url" id="video_src" name="video_src" placeholder="يمكنك إضافة مقطع فيديو من موقع youtube أو Viemo" class="span11" />
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label">نص الموضوع</label>
                                            <div class="controls">
                                                <textarea class="span11 ckeditor" id="news_description" rows="6"></textarea>
                                            </div>
                                        </div>
        ...
        <script>
            ...
            function add_news() {
                ...
                $.ajax({
                    type: "POST",
                    url: '<?php echo base_url() . "admin/media/do_add_v_news/"; ?>',
                    data: {
